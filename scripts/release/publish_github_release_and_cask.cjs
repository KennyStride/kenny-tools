...
const DEFAULT_CASK_PATH = 'Casks/kenny-tools.rb';
...
function printHelp() {
  ...
  console.log('  --cask <path>           Homebrew cask file path (default: Casks/kenny-tools.rb)');
...
function main() {
  ...
  console.log('- 检查 Casks/kenny-tools.rb diff');
